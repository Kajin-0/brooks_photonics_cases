...
.hero{width:100%;height:2.08in;object-fit:cover;object-position:center top;border-radius:0;display:block}
...
.card{border:1px solid #DDE2EA;border-radius:0;padding:12px;background:white}.card h3{color:#243044}.card p{font-size:8.9pt;color:#4D5869;margin-bottom:0}.card .num{font-size:18pt;font-weight:750;color:#6A3FA0;margin-bottom:3px}.card.orange .num{color:#C35B2A}.card.teal .num{color:#157A7A}.card.blue .num{color:#2D5F9A}
...
.banner{background:#172033;color:white;padding:15px 17px;border-radius:0;margin:12px 0}.banner .big{font-size:15.5pt;font-weight:700;line-height:1.24}.banner .sub{font-size:8.6pt;color:#D6DCE5;margin-top:6px}
.pill{display:inline-block;border-radius:0;padding:3px 7px;background:#E9DFF4;color:#4A286F;font-weight:700;font-size:7.2pt;margin-right:4px}.pill.orange{background:#F7E4DB;color:#8C3F20}.pill.teal{background:#DCEEEE;color:#0F5E5E}.pill.gray{background:#EDF0F4;color:#455163}
.reco{display:grid;grid-template-columns:30px 1fr;gap:9px;margin:8px 0}.reco .n{width:26px;height:26px;background:#6A3FA0;color:white;border-radius:0;text-align:center;line-height:26px;font-weight:700}.reco h3{margin-bottom:1px}.reco p{font-size:8.8pt;color:#4D5869;margin-bottom:0}
...
.result-strip{display:grid;grid-template-columns:1fr 1fr;gap:1px;background:#CFD6E1;border-radius:0;overflow:hidden;margin:10px 0 12px}.result-strip>div{background:#172033;color:white;padding:12px 15px}.result-strip .big{font-size:17pt;font-weight:750;line-height:1.05}.result-strip .small{font-size:7.8pt;color:#D4DAE4;margin-top:4px}
.commercial{border:1px solid #D9CBE7;background:#FBF9FD;padding:12px 14px;border-radius:0}.commercial ul{margin:5px 0 0 17px;padding:0}.commercial li{font-size:8.8pt;color:#425066;margin:4px 0}
...
.cta{background:#172033;color:white;border-radius:0;padding:17px 19px}.cta h3{font-size:14.5pt;color:white;margin-bottom:6px}.cta p{font-size:8.8pt;color:#D8DEE8;margin-bottom:4px}.cta .contact{font-size:9.5pt;font-weight:700;color:white;margin-top:9px}
