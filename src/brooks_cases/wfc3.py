...
# Hardware/calibration defects that should be rejected for an independent ramp
# diagnostic. DATAREJECT=8192 is intentionally omitted because it is generated by
# the up-the-ramp algorithm and is itself a quantity of interest in this case.
PERMANENT_REJECT_BITS = 1 | 2 | 4 | 8 | 16 | 32 | 128 | 256 | 512 | 2048 | 32768
DATAREJECT_BIT = 8192
